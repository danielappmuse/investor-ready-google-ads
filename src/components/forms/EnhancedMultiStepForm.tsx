...
const EnhancedMultiStepForm = ({ onSuccess, formLocation, onBack }: EnhancedMultiStepFormProps) => {
  ...
  const submitLeadData = async (step: number) => {
    const leadData: ContactFormData = {
      ...
      project_type: watchedFields.project_type || '',
      budget_range: watchedFields.budget_range || '',
      project_description: watchedFields.project_description || '',
      nda_agreement: watchedFields.nda_agreement || false,
