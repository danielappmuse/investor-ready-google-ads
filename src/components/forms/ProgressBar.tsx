    ...
    <div className="fixed top-14 sm:top-16 lg:top-20 left-0 right-0 z-50 bg-background/80 backdrop-blur-lg border-b border-border/50">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 py-3 sm:py-4">
        <div className="flex items-center justify-end mb-2 sm:mb-3">
          <span className="text-xs sm:text-sm font-medium text-foreground bg-card/50 px-2 sm:px-3 py-1 sm:py-1.5 rounded-full border border-border/50 whitespace-nowrap">
