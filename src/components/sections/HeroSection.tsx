            ...
            <div className="space-y-0.5 sm:space-y-3 lg:space-y-4 2xl:space-y-6 3xl:space-y-8 animate-fade-in-up text-center xl:text-center flex flex-col items-center">
              <div className="space-y-0.5 sm:space-y-2 lg:space-y-3 2xl:space-y-4 3xl:space-y-6">
                ...
                <p className={`${isSmallScreen ? 'text-[14.5px]' : 'text-[17.5px]'} sm:text-base lg:text-[20px] text-white leading-snug animate-fade-in stagger-2 max-w-2xl 2xl:max-w-3xl 3xl:max-w-4xl mt-1.5`}>
                  <div data-hero-container dangerouslySetInnerHTML={{
                    __html: (window as any).__HERO_TEXT__?.headline || 
                      ...
                      <span className="block h-2 lg:h-8"></span>
              ...
              <div className="card-glass p-6 sm:p-8 lg:p-10 text-center">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6 mb-8">
                  <div className="flex items-start space-x-3">
                    ...
                    <div className="text-[16.5px] sm:text-base lg:text-lg text-gray-300">
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mt-8">
                  <div className="flex flex-col items-center text-center p-4 bg-white/5 rounded-lg border border-white/10">
                    ...
                    <span className="text-[16.5px] sm:text-base font-medium text-white">Founder to Founder</span>
                  </div>
                  <div className="flex flex-col items-center text-center p-4 bg-white/5 rounded-lg border border-white/10">
                    <Target className="w-8 h-8 text-primary mb-2" />
                    <span className="text-[16.5px] sm:text-base font-medium text-white">YC-level Process</span>
                  </div>
                  <div className="flex flex-col items-center text-center p-4 bg-white/5 rounded-lg border border-white/10">
                    <Briefcase className="w-8 h-8 text-primary mb-2" />
                    <span className="text-[16.5px] sm:text-base font-medium text-white">Full-stack Business Suite</span>
                  </div>
                  <div className="flex flex-col items-center text-center p-4 bg-white/5 rounded-lg border border-white/10">
                    <BadgeCheck className="w-8 h-8 text-primary mb-2" />
                    <span className="text-[16.5px] sm:text-base font-medium text-white">Become Investor Ready</span>
                  </div>
                  <div className="flex flex-col items-center text-center p-4 bg-white/5 rounded-lg border border-primary/30 col-span-2 md:col-span-4">
                    ...
                    <span className="text-[16.5px] sm:text-lg font-bold text-white">Access to Real Investors</span>
                  </div>
                </div>
                ...
                <div className="mt-8">
                  <Button onClick={() => setCurrentView('prototype-form')} className="btn-hero w-full text-[15.5px] sm:text-[21.5px] font-extrabold py-3.5 sm:py-6 rounded-xl animate-cta-pulse group relative overflow-hidden">
                    <span className="relative z-10 flex items-center justify-center gap-1.5 sm:gap-3 leading-tight">
                      <Sparkles className="w-4 h-4 sm:w-6 sm:h-6 animate-pulse flex-shrink-0" />
                      <span className="text-center">Start Assessment Now!</span>
                      <ArrowRight className="w-4 h-4 sm:w-6 sm:h-6 group-hover:translate-x-1 transition-transform flex-shrink-0" />
                    </span>
                  </Button>
                </div>
                  ...
                  {[
                    {
                      ...
                      description: 'Build the foundation with comprehensive market research, business plan & model.',
                      details: [
        ...
        {currentView === 'prototype-form' && <div className="max-w-4xl mx-auto">
            <div className="text-center mb-8">
              ...
              <p className="text-lg sm:text-xl lg:text-2xl text-gray-300">
                ...
                <span className="block mt-2 text-[16.5px] sm:text-sm text-gray-400">(Fill the questions carefully, we can only onboard up to 10 new entrepreneurs per month)</span>
              </p>
            </div>
