...
const HeroSection = ({
  ...
  return <section id="get-started" className="min-h-screen flex items-center pt-16 sm:pt-20 lg:pt-24 pb-2 sm:pb-6 lg:pb-8 relative overflow-hidden">
      {/* Animated Background */}
      <AnimatedBackground />
      ...
      <div className="container mx-auto px-3 sm:px-4 lg:px-6 xl:px-8 2xl:px-12 3xl:px-16 relative z-10">
        {currentView === 'products' && <div className="grid grid-cols-1 xl:grid-cols-2 gap-2 sm:gap-5 lg:gap-6 items-center">
            {/* Hero Content */}
            <div className="space-y-1 sm:space-y-3 lg:space-y-4 2xl:space-y-6 3xl:space-y-8 animate-fade-in-up text-center xl:text-left">
              <div className="space-y-1 sm:space-y-2 lg:space-y-3 2xl:space-y-4 3xl:space-y-6 flex flex-col items-center xl:items-start">
                <div className={`inline-flex items-center px-2 sm:px-3 2xl:px-4 3xl:px-5 py-0.5 sm:py-1 2xl:py-1.5 3xl:py-2 bg-gradient-to-r from-primary/20 to-secondary/20 border border-primary/30 rounded-full ${isSmallScreen ? 'text-[13px]' : 'text-[16px]'} sm:text-lg lg:text-xl 2xl:text-2xl 3xl:text-3xl font-bold text-white animate-pulse-glow`}>
                ...
                <h1 className={`${isSmallScreen ? 'text-[17px]' : 'text-[22px]'} sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl 2xl:text-7xl 3xl:text-8xl font-bold text-white leading-tight tracking-tight animate-fade-in stagger-1`}>
                  From Idea to{' '}
                ...
                <p className={`${isSmallScreen ? 'text-[10.5px]' : 'text-[15px]'} sm:text-base lg:text-lg 2xl:text-xl 3xl:text-2xl text-gray-300 leading-snug animate-fade-in stagger-2 max-w-2xl 2xl:max-w-3xl 3xl:max-w-4xl`}>
                  ...
                  <span className="hidden sm:inline"><br /><br /></span>
            ...
            {/* Right Column - CTA */}
            <div className="space-y-1 sm:space-y-3 lg:space-y-4 2xl:space-y-6 3xl:space-y-8 animate-slide-in-right mt-1 xl:mt-0 max-w-lg 2xl:max-w-xl 3xl:max-w-2xl mx-auto xl:mx-0 w-full px-2 text-center xl:text-left">
              <div className="animate-fade-in stagger-4 w-full flex flex-col items-center xl:items-start">
                ...
                {/* Trust Badges */}
                <div className="flex flex-nowrap gap-1.5 sm:gap-2 mb-1.5 sm:mb-3 2xl:mb-4 3xl:mb-5 overflow-x-auto scrollbar-hide justify-center xl:justify-start">
                ...
                <div className="space-y-1 sm:space-y-3 2xl:space-y-4 3xl:space-y-5">
                  <div className="group w-full max-w-full overflow-hidden p-2 sm:p-5 lg:p-6 2xl:p-8 3xl:p-10 border-2 border-white/20 rounded-lg card-glass">
                    <div className="mb-1 sm:mb-4 2xl:mb-5 3xl:mb-6">
                      <h3 className={`${isSmallScreen ? 'text-[12px]' : 'text-[15px]'} sm:text-lg lg:text-xl 2xl:text-2xl 3xl:text-3xl font-bold text-white group-hover:gradient-text transition-all leading-tight`}>
                        Investor-Readiness Assessment
                      </h3>
                    </div>
                    <p className={`${isSmallScreen ? 'text-[9.5px]' : 'text-[14px]'} sm:text-base 2xl:text-lg 3xl:text-xl text-gray-300 mb-1.5 sm:mb-5 2xl:mb-6 3xl:mb-7 leading-tight sm:leading-snug`}>Get interviewed by professionals who worked inside VC's & founders who've raised capital multiple times.</p>
                    ...
                    <Button onClick={() => setCurrentView('prototype-form')} className="btn-hero w-full text-[11px] sm:text-base py-2 sm:py-3">
                      <span className="leading-tight">Click Here to Become Investor Ready in 90 days!</span>
                    </Button>
                  </div>
                </div>
              </div>
