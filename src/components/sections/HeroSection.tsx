...
const HeroSection = ({
  ...
  return <section id="get-started" className="min-h-screen flex items-center justify-center pt-[61px] sm:pt-24 lg:pt-28 pb-1 sm:pb-6 lg:pb-8 relative overflow-hidden">
      {/* Animated Background */}
      <AnimatedBackground />
      ...
      <div className="container mx-auto px-3 sm:px-4 lg:px-6 xl:px-8 2xl:px-12 3xl:px-16 relative z-10">
        {currentView === 'products' && <div className="grid grid-cols-1 xl:grid-cols-2 gap-4 sm:gap-5 lg:gap-6 items-center">
            ...
            {/* Right Column - CTA */}
            <div className="space-y-1 sm:space-y-3 lg:space-y-4 2xl:space-y-6 3xl:space-y-8 animate-slide-in-right mt-2 xl:mt-0 max-w-lg 2xl:max-w-xl 3xl:max-w-2xl mx-auto w-full px-2 flex flex-col items-center">
              <div className="animate-fade-in stagger-4 w-full flex flex-col items-center">
                <div className={`inline-flex items-center px-2 sm:px-3 2xl:px-4 3xl:px-5 py-1 2xl:py-1.5 3xl:py-2 bg-gradient-to-r from-primary/20 to-secondary/20 border border-primary/30 rounded-full ${isSmallScreen ? 'text-[15px]' : 'text-[18px]'} sm:text-lg lg:text-xl 2xl:text-2xl 3xl:text-3xl font-bold text-white animate-pulse-glow mb-[5px] sm:mb-4`}>
                ...
                {/* Trust Badges */}
                <div className="flex flex-nowrap gap-1.5 sm:gap-2 mt-[3px] mb-2 sm:mb-3 2xl:mb-4 3xl:mb-5 overflow-x-auto scrollbar-hide justify-center">
