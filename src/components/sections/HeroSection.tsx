...
const HeroSection = ({
  ...
  return <section id="get-started" className="min-h-screen flex items-center pt-16 sm:pt-20 lg:pt-24 pb-4 sm:pb-6 lg:pb-8 relative overflow-hidden">
      {/* Animated Background */}
      <AnimatedBackground />
      ...
      <div className="container mx-auto px-3 sm:px-4 lg:px-6 xl:px-8 2xl:px-12 3xl:px-16 relative z-10">
        {currentView === 'products' && <div className="grid grid-cols-1 xl:grid-cols-2 gap-3 sm:gap-5 lg:gap-6 items-center max-w-7xl mx-auto">
            {/* Hero Content */}
            <div className="space-y-2 sm:space-y-3 lg:space-y-4 2xl:space-y-6 3xl:space-y-8 animate-fade-in-up text-center xl:text-left flex flex-col items-center xl:items-start">
              <div className="space-y-1.5 sm:space-y-2 lg:space-y-3 2xl:space-y-4 3xl:space-y-6">
                ...
                <p className={`${isSmallScreen ? 'text-[11px]' : 'text-[14px]'} sm:text-base lg:text-lg 2xl:text-xl 3xl:text-2xl text-gray-300 leading-snug animate-fade-in stagger-2 max-w-2xl 2xl:max-w-3xl 3xl:max-w-4xl`}>
            ...
            {/* Right Column - CTA */}
            <div className="space-y-2 sm:space-y-3 lg:space-y-4 2xl:space-y-6 3xl:space-y-8 animate-slide-in-right mt-3 xl:mt-0 max-w-lg 2xl:max-w-xl 3xl:max-w-2xl mx-auto xl:mx-0 w-full px-2 flex flex-col items-center xl:items-start">
              <div className="animate-fade-in stagger-4 w-full text-center xl:text-left flex flex-col items-center xl:items-start">
                ...
                {/* Trust Badges */}
                <div className="flex flex-nowrap gap-1.5 sm:gap-2 mt-[13px] mb-1 sm:mb-2 2xl:mb-3 3xl:mb-4 overflow-x-auto scrollbar-hide justify-center xl:justify-start">
                ...
                <div className="space-y-1 sm:space-y-3 2xl:space-y-4 3xl:space-y-5 mt-[8px]">
                  <div className="group w-full max-w-full overflow-hidden p-3 sm:p-5 lg:p-6 2xl:p-8 3xl:p-10 border-2 border-white/20 rounded-lg card-glass">
                    ...
                    <p className={`${isSmallScreen ? 'text-[10px]' : 'text-[13px]'} sm:text-base 2xl:text-lg 3xl:text-xl text-gray-300 mb-2.5 sm:mb-5 2xl:mb-6 3xl:mb-7 leading-tight sm:leading-snug`}>Get interviewed by professionals who worked inside VC's & founders who've raised capital multiple times.</p>
                    ...
                    <Button onClick={() => setCurrentView('prototype-form')} className="btn-hero w-full text-[11px] sm:text-base py-2 sm:py-2">
                      <span>Click Here to
